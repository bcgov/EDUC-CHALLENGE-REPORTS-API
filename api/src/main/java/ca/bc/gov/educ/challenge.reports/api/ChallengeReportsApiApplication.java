...
/**
 * The ChallengeReports api application.
 *
 */
...
@EnableRetry
public class ChallengeReportsApiApplication {
  ...
  public static void main(final String[] args) {
    SpringApplication.run(ChallengeReportsApiApplication.class, args);
  }
