...
public class PurgeOldSagaRecordsScheduler {
  ...
  @Getter(PRIVATE)
  private final ChallengeReportsSagaEventRepository sagaEventRepository;
  ...
  public PurgeOldSagaRecordsScheduler(final ChallengeReportsSagaRepository sagaRepository, final ChallengeReportsSagaEventRepository sagaEventRepository) {
  ...
  public void pollSagaTableAndPurgeOldRecords() {
    ...
    log.info("Purged old saga and event records from EDUC-CHALLENGE-REPORTS-API");
  }
