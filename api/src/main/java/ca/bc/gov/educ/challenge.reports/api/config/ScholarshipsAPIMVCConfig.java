package ca.bc.gov.educ.challenge.reports.api.config;
 ...
 */
@Configuration
public class ChallengeReportsAPIMVCConfig implements WebMvcConfigurer {
   ...
   */
  @Autowired
  public ChallengeReportsAPIMVCConfig(final RequestResponseInterceptor requestResponseInterceptor) {
