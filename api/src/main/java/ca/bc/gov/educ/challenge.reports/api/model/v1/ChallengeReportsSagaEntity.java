...
@Data
@Entity
@Table(name = "CHALLENGE_REPORTS_SAGA")
@DynamicUpdate
public class ChallengeReportsSagaEntity {
  ...
  @Column(name = "CHALLENGE_REPORTS_SESSION_ID", columnDefinition = "BINARY(16)")
  UUID challengeReportsSessionId;
