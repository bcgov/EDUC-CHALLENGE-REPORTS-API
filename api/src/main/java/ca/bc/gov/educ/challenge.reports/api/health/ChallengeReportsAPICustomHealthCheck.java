package ca.bc.gov.educ.challenge.reports.api.health;
...
@Component
@Slf4j
public class ChallengeReportsAPICustomHealthCheck implements HealthIndicator {
  private final Connection natsConnection;

  public ChallengeReportsAPICustomHealthCheck(final Connection natsConnection) {
