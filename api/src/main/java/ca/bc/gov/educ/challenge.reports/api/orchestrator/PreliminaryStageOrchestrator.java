...
public class PreliminaryStageOrchestrator extends BaseOrchestrator<PreliminaryStageSagaData> {
    ...
    public void populateStepsToExecuteMap() {
        this.stepBuilder()
                .begin(SEND_OUT_PRELIMINARY_EMAIL, this::closeCurrentCollAndOpenNewColl)
    ...
    public void closeCurrentCollAndOpenNewColl(final Event event, final ChallengeReportsSagaEntity saga, final PreliminaryStageSagaData sagaData) throws JsonProcessingException {
